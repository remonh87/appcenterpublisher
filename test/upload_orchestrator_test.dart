  ...
  group('Start upload', () {
    ...
    group('GIVEN create uploadurl succeeds', () {
        ...
        group('AND commit release succeeds', () {
          ...
          setUp(() {
            when(
              uploader.commitUpload(
                ...
                CommitReleaseResult.success(commitReleaseSuccess)));
          });
          ...
          group('AND distribute to group fails', () {
            setUp(() {
              ...
              ).thenAnswer((_) => Future.value(DistributionResult.failure(
          ...
          setUp(() {
            when(
              uploader.commitUpload(
                  ...
                  config: anyNamed('config'),
                  appName: anyNamed('appName')),
            ).thenAnswer((_) => Future.value(CommitReleaseResult.failure(
      ...
      group('AND uploadBinary fails', () {
        ...
        setUp(() async {
          when(uploader.uploadBinary(any, any, any)).thenAnswer((_) =>
              Future.value(UploadBinaryResult.failure(
